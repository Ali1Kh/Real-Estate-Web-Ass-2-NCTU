...
const items = [
  ...
  {
    photo: "/assets/images/property-imgs/Img1.png",
    title: "Northside Drive apartment",
  ...
  {
    photo: "/assets/images/property-imgs/Img3.png",
    title: "Riverside Drive apartment",
...
function filterAndSort() {
  ...
  const buyRent = document.getElementById("buyRentFilter").value;
  const sort = document.getElementById("sortFilter").value;

  filteredProperties = items.filter((property) => {
    const matchesType = !type || type == "all" || property.type == type;
    const matchesBuyRent =
      !buyRent || buyRent == "all" || property.buyRent == buyRent;
    return matchesType && matchesBuyRent;
  });
